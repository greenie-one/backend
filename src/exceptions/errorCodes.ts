export enum ErrorEnum {
  ...
  WORKEXPERIENCE_NOT_FOUND = 5,
  SKILL_NOT_FOUND = 6,
  USER_DETAILS_NOT_FOUND = 7,
  INVALID_DATE = 8,

  // Waitlist
  ALREADY_IN_WAITLIST = 9,

  // Models
  FAILED_TO_CREATE_USER = 10,
  FAILED_TO_CREATE_PROFILE = 11,
  INVALID_USER_ID = 12,
  EDUCATION_NOT_FOUND = 13,
  RESIDENTIAL_INFO_NOT_FOUND = 14,
  DOCUMENTS_NOT_FOUND = 15,
  DOCUMENT_NOT_FOUND = 16,
  DOCUMENT_IS_PUBLIC = 17,
  DOCUMENT_ALREADY_SHARED = 18,
  DOCUMENT_NOT_SHARED = 19,
  DOCUMENT_EXPIRED = 20,
  DOCUMENT_ALREADY_UPLOADED = 21,
  INVALID_COORDINATES = 22,
  PEER_NOT_FOUND = 23,

  //identity verification
  NUMBER_NOT_LINKED = 24,
  SERVER_ERROR = 25,
  AADHAR_NOT_FOUND = 26,
  PAN_VERIFICATION_FAIL = 27,
  DRIVING_LICENSE_VERIFICATION_FAIL = 28,
  Aadhaar_Verification_FAIL = 29,
  RATE_LIMIT_EXCEEDED = 30,
  USER_LOCATION_NOT_FOUND = 31,
  AADHAR_VERIFICATION_REQUIRED = 32,
  AADHAR_ALREADY_EXIST = 33,
  PAN_ALREADY_EXIST = 34,
  DRIVING_LICENSE_ALREADY_EXIST = 35,

  // Peer
  SHARING_FAILED = 36,
  SHARING_NOT_FOUND = 37,
  INVALID_PEER_UUID = 38,
  INVALID_PEER_ID = 39,
  PEER_EMAIL_NOT_VERIFIED = 40,
  INVALID_OTP = 41,
  CALL_API_FAILED = 42,
  INVALID_VERIFICATION_FIELDS = 43,
  PEER_PHONE_NOT_VERIFIED = 44,
  PEER_ALREADY_EXISTS = 45,
  PEER_ALREADY_VERIFIED = 46,
  INCOMPLETE_VERIFICATION = 47,
}
